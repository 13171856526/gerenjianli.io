<template>
  <div id="show-resume">
    <div
      id="resume_content"
      class="resume-content clearfloat"
    ...
    >
      <section class="section-left">
        ...
        <div class="interest">
          <h3><span class="item-title">求职意向</span></h3>
          <p>
            <span
              class="inte-span"
              v-for="item in resumeData.head.interest.split('、')"
              >{{ item }}</span
            >
          </p>
        </div>
        <div class="skill">
          ...
          <div
            class="sk"
            v-for="(item, index) in resumeData.head.speciality.split('、')"
          >
            {{ item }}
            <div class="sk-wrap">
              <span
                class="sk-per"
                :style="{
                  width: resumeData.head.specialityPer.split('、')[index] + '%'
                }"
              ></span>
            </div>
          </div>
      ...
      <section class="section-right">
        <div class="blog-box clearfloat">
          <div class="blog">
            ...
            <div class="link github">
              <i class="icon-github-alt icon-1x"></i>Github:
              <a target="_blank" href="https://github.com/ZengTianShengZ">{{
                resumeData.blogLink.github
              }}</a>
            </div>
            <div class="link personal-blog">
              <i class="icon-flag icon-1x"></i>技术博文
              <a target="_blank" href="https://segmentfault.com/u/zss">{{
                resumeData.blogLink.blog
              }}</a>
            </div>
          </div>
        </div>
        <div class="experience work-experience">
          ...
          <div
            class="show"
            v-for="item in resumeData.workExperience.experience"
          >
        ...
        <div class="experience project-experience">
          <div class="title">
            ...
            <div class="title-date">
              {{ resumeData.projectExperience.time }}
            </div>
          </div>
          <div
            class="show"
            v-for="item in resumeData.projectExperience.experience"
          >
            <div class="item" v-if="item.name">
              <div class="item-title">
                <span class="item-name">{{ item.name }}</span>
        ...
        <div class="experience skill-experience">
          ...
          <div class="show" v-for="item in resumeData.skill">
        ...
        <div class="experience self-evaluation">
          ...
          <p class="eval-detail" v-for="item in resumeData.selfAssessment">
            {{ item }}
          </p>
        </div>
      </section>
